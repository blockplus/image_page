...
* Api Endpoints
*/
define('API_SIMILAR_IMAGE', 'similar_image');
define('API_ADD_IMAGE', 'add_image');
define('API_DELETE_IMAGE', 'delete_image');
define('API_SEARCH_IMAGE_PAGE', 'search_image_page');

define('API_RESIZE_IMAGE', 'resize_image_api');